...
I trained a neural network model with the input synthetic colors to predict the probability of a star being a giant. Tested with existing spectroscopic catalogs, the model reaches over 90 /% accuracy.